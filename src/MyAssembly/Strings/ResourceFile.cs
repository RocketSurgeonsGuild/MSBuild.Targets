...
{
    private static readonly Regex FormatExpression = new("{(?<arg>[^:{}]+)(?::(?<format>[^{}]+))?}", RegexOptions.Compiled);
    ...
    public static ResourceArea Load(IEnumerable<XElement> data, string rootArea)
    {
        ...
        foreach (var element in data)
        {
            ...
            var areaParts = id.Split(["_"], StringSplitOptions.RemoveEmptyEntries);
    ...
    private static ResourceValue GetValue(string resourceId, string resourceName, string resourceValue)
    {
